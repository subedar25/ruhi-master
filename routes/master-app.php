...
use App\Http\Controllers\MasterApp\RuhiReportController;
...
Route::prefix('master-app')
    ...
    ->group(function ()
    {
        ...
        Route::prefix('ruhi-reports')->name('ruhi-reports.')->group(function () {
            ...
            Route::get('/gs-wise-casting-report', [RuhiReportController::class, 'gsWiseCastingReport'])->name('gs-wise-casting-report');
            Route::get('/gs-wise-casting-report/print', [RuhiReportController::class, 'gsWiseCastingReportPrint'])->name('gs-wise-casting-report.print');
            Route::get('/gs-wise-casting-detail-report', [RuhiReportController::class, 'gsWiseCastingDetailReport'])->name('gs-wise-casting-detail-report');
            Route::get('/gs-wise-casting-detail-report/print', [RuhiReportController::class, 'gsWiseCastingDetailReportPrint'])->name('gs-wise-casting-detail-report.print');
            Route::get('/gs-wise-dubby-report', [RuhiReportController::class, 'gsWiseDubbyReport'])->name('gs-wise-dubby-report');
            Route::get('/gs-wise-dubby-report/print', [RuhiReportController::class, 'gsWiseDubbyReportPrint'])->name('gs-wise-dubby-report.print');
            Route::get('/gs-wise-collet-report', [RuhiReportController::class, 'gsWiseColletReport'])->name('gs-wise-collet-report');
            Route::get('/gs-wise-collet-report/print', [RuhiReportController::class, 'gsWiseColletReportPrint'])->name('gs-wise-collet-report.print');
            Route::get('/gs-color-collet-report', [RuhiReportController::class, 'gsColorColletReport'])->name('gs-color-collet-report');
            ...
            Route::get('/gs-wise-drop-report/print', [RuhiReportController::class, 'gsWiseDropReportPrint'])->name('gs-wise-drop-report.print');
            Route::get('/gs-full-report', [RuhiReportController::class, 'gsFullReport'])->name('gs-full-report');
            Route::get('/gs-full-report/print', [RuhiReportController::class, 'gsFullReportPrint'])->name('gs-full-report.print');
            Route::get('/gs-die-report', [RuhiReportController::class, 'gsDieReport'])->name('gs-die-report');
