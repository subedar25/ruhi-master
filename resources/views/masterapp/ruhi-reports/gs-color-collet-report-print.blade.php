...
<head>
    ...
    <title>GS Color Collet Report</title>
    <style>
    ...
    <table class="data">
        ...
        <tbody>
            @foreach($report['rows'] as $r)
                <tr>
                    ...
                    <td>{{ number_format((float) $r['weight'], 2, '.', '') }}</td>
                </tr>
            @endforeach
        </tbody>
        @if(count($report['rows']) > 0)
            <tfoot>
                <tr>
                    <td>Grand Total</td>
                    <td>{{ number_format((int) $report['grand_red'], 0, '.', '') }}</td>
                    <td>{{ number_format((int) $report['grand_green'], 0, '.', '') }}</td>
                    <td>{{ number_format((float) $report['grand_weight'], 2, '.', '') }}</td>
                </tr>
            </tfoot>
        @endif
    </table>
